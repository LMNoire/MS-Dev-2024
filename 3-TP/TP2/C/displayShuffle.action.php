...
$studentsList = [ "Simon", "Nacim", "Mathilde", "Amelie", "Ricky", "Lyess", "Dylan", "Lorena", "Tina", "Jeremy", "Florent", "Messaoud", "Farid", "Selim", "Abdel-Karim","", "T"];

$studentsLocations = createStudentLocations($placesList, $studentsList);

$studentsLocations = shuffleLocations($studentsLocations);

$_SESSION["studentToDisplay"] = $studentsLocations;
