...
function placesrestantes (Int $nombre_places_parking, Int $nombres_voitures): Int {
    return $nombre_places_parking - $nombres_voitures;
}


echo "Il reste " .placesrestantes($nombre_places_parking, $nombres_voitures). " places";