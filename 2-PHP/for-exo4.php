...
for ($i = 0; $i <= 100; $i++) {
    ...
    if ($reste_des_centaines == 0) {
        ...
        $dizaine = 'quarante-vingts';
    } else if ($reste_des_centaines == 90) {
        $dizaine = 'quarante-vingts dix';
    }
    ...
    if ($i == 0) {
        ...
        $nombre = $dizaine;
    } else if (($reste_des_dizaines == 1 && $i > 10) && $reste_des_centaines != 80) {
        $liaison_dizaine = '-et-';
    ...
    if ($i == 91) {
        ...
        $nombre = 'quatre-vingts-dix-sept';
    } else if ($i == 98) {
        $nombre = 'quatre-vingts-dix-huit';
    } else if ($i == 99) {
        $nombre = 'quatre-vingts-dix-neuf';
    }
