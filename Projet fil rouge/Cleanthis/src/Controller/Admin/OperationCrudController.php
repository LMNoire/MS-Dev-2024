...
class OperationCrudController extends AbstractCrudController {
    ...
    public function configureCrud(Crud $crud): Crud {
        return $crud
            ...
            ->setSearchFields(['id', 'type', 'name', 'price', 'status', 'zipcode_ope', 'city_ope', 'street_ope', 'customer.name', 'customer.firstname', 'customer.email', 'salarie.name', 'salarie.firstname', 'salarie.email', 'created_at', 'finished_at'])
