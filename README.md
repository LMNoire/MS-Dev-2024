...
- JANVIER : Commandes linux, TP de groupe reprenant les trois premiers mois, API/Json, Javascript, affichage dynamique sur une page, requête ajax/Jquery, frameworks symfony pour php
...
- 3-TP : Suite de TP sur l'utilisation d'une architecture MVC, création de différentes vues, modèles et contrôleurs, POO, BDD, affichage dynamique, requête ajax/Jquery, intégration d'API, frameworks symfony pour php 
