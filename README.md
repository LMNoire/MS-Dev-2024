...
- JANVIER : Commandes linux, intégration API + Json, Javascript, affichage dynamique sur une page, requêtes ajax/Jquery, frameworks Symfony pour PHP
...
- 3-TP : Suite de TP sur l'utilisation d'une architecture MVC, création de différentes vues, modèles et contrôleurs, POO, BDD, affichage dynamique, requêtes ajax/Jquery, intégration d'API, frameworks Symfony pour PHP
